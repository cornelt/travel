...
import stylesCss from 'themes/travel/styles.css?inline';
...
import vaadinButtonCss from 'themes/travel/components/vaadin-button.css?inline';
import vaadinPasswordFieldCss from 'themes/travel/components/vaadin-password-field.css?inline';
import vaadinTextAreaCss from 'themes/travel/components/vaadin-text-area.css?inline';
import vaadinTextFieldCss from 'themes/travel/components/vaadin-text-field.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_travel_componentCss']) {
    registerStyles(
      'vaadin-button',
    ...
    document['_vaadintheme_travel_componentCss'] = true;
  }
